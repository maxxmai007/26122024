...
const spendingSchema = z.object({
  ...
  utilities: z.number().min(1000, 'Please enter your spending amount'),
  entertainment: z.number().min(1000, 'Please enter your spending amount'),
});
...
export function SpendingHabits({ onNext }: SpendingHabitsProps) {
  ...
  const spendingCategories = [
    ...
    { id: 'utilities', label: 'Utilities and Household Bills' },
    { id: 'entertainment', label: 'Entertainment and Leisure' }
  ];
